...
#         train_acc += acc
#         num += len(x)
#     testAcc = evaluatAcc(testIter, net)
#     print('epoch {}'.format(i), 'loss: {}'.format(train_l/num), 'trainAcc: {}'.format(train_acc/num), 'testAcc: {}'.format(testAcc))